...
export default function SeagoingVessel() {
  return (
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    <div className="mt-4">
                      <Link
                        className="bg-transparent hover:bg-blue-700 text-blue-500 font-bold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded-full"
                        href="vessel/seagoingVessel/form">
                        선박 / 항해 선박 / 공장선 만들기
                      </Link>
                    </div>
                  </span>
